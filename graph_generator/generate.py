...
def main( args ):
	...
	if args.output is not None:
		...
		adj_outfile = 'adj_%dx%dx%d.txt' % (scale_l, scale_r, edge_factor)
		edge_outfile = 'edge_%dx%dx%d.txt' % (scale_l, scale_r, edge_factor)
  ...
  #############################################################################
	...
	bipart.generate_bipartite(covered=covered)
